...
vector<Entry> searchFirstAndLast(vector<Entry> entryVec, string firstMonth, 
    ...
    bool firstDayFound = false, firstMonthFound = false, lastMonthFound = false, errorDate = false;
 ...
 * O(N) complexity because it goes trough each of the characters in the line
...
Entry line2data(string line){
    ...
    /*
      ...
      Go trhough each character of the line. And keep count
